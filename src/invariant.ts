...
/**
 * No runtime invariant: this package is a read-only fold of the session
 * list's projection values onto one footer slot entry. It emits no cordis
 * events, owns no cross-plugin mutable state, and its single slot
