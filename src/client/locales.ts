...
export const zh = {
  ...
  'trend.month': '近 30 天',
  'trend.all': '全部',
  'trend.axis.date': '{month}月{day}日',
  'trend.windowEmpty': '该时间尺度下没有可统计的会话',
  'table.title': '按会话',
  'table.session': '会话',
  'table.model': '模型',
  'table.turns': '轮次 / 步数',
...
export const en: Record<DashboardKey, string> = {
  ...
  'trend.scale': 'Time scale',
  'trend.week': '7 days',
  'trend.month': '30 days',
  'trend.all': 'All',
  'trend.axis.date': '{month}/{day}',
  'trend.windowEmpty': 'No sessions with usage in this range',
